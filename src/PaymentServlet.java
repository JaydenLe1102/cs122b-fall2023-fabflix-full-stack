...
public class PaymentServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) {
        try {
            dataSource = (DataSource) new InitialContext().lookup("java:comp/env/jdbc/CS122B_Proj1");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            JsonObject paymentResponse = PaymentService.processPayment(dataSource, request, customerId, ccId, firstName, lastName, expiration);
