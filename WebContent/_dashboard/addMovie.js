function handleAddMovie(resultData) {
    ...
    if (resultData['success'] === true) {
        const movieId = resultData['movieId']
        const starId = resultData['starId']
        const genreId = resultData['genreId']

        alert(
            `Add Movie Success with movie id: ${movieId}, star id: ${starId}, genre id: ${genreId}`
        )
    } else {
        alert('Add Movie Failed Due to duplicate movie')
    }
